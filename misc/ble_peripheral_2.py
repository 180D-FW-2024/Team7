...
class IMUAdvertisement(advertisement.Advertisement):
    ...
    def __init__(self, device_name):
        ...
        self.service_UUIDs = [
            "1b9998a2-1234-5678-1234-56789abcdef0"
        ]  # IMU Service UUID
...
class IMUPeripheral:
    ...
    def __init__(self, adapter_address=None):
        ...
        self.adapter = adapter.Adapter(
            adapter_address or list(adapter.Adapter.available())[0].address
        )
    ...
    def _setup_gatt(self):
        ...
        logger.info(
            f"Added characteristic for Accelerometer with UUID: {self.ACCEL_CHAR_UUID}"
        )
        ...
        logger.info(
            f"Added characteristic for Gyroscope with UUID: {self.GYRO_CHAR_UUID}"
        )
        ...
        logger.info(
            f"Added characteristic for Magnetometer with UUID: {self.MAG_CHAR_UUID}"
        )
