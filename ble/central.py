            ...
            if client.is_connected:
                ...
                while True:
                    ...
                    try:
                        ...
                        if enable_print:
                            print(
                                f"  Accelerometer (mg): X={accel_data[0]:09.3f}, Y={accel_data[1]:09.3f}, Z={accel_data[2]:09.3f}",
                                end="  ",
                            )
                        if enable_print:
                            print(
                                f"  Gyroscope (DPS): X={gyro_data[0]:09.3f}, Y={gyro_data[1]:09.3f}, Z={gyro_data[2]:09.3f}"
                            )
