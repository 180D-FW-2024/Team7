            ...
            if client.is_connected:
                ...
                while True:
                    ...
                    try:
                        ...
                        if enable_print: print(f"  Accelerometer (mg): X={accel_data[0]:09.3f}, Y={accel_data[1]:09.3f}, Z={accel_z_normalized:09.3f}", end="  ")
                        if enable_print: print(f"  Gyroscope (DPS): X={gyro_data[0]:09.3f}, Y={gyro_data[1]:09.3f}, Z={gyro_data[2]:09.3f}")

                        # adding to socket
                        if run_with_socket:
                            accel_data = f"{accel_data[0]},{accel_data[1]},{accel_z_normalized}"
