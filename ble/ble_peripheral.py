...
accel_characteristic = aioble.Characteristic(imu_service, _ACCEL_UUID, read=True, notify=True)
gyro_characteristic = aioble.Characteristic(imu_service, _GYRO_UUID, read=True, notify=True)
